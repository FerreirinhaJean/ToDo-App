...
public class TaskService {
    ...
    public Task create(TaskCreationRequestDTO taskCreationRequestDTO, String email) {
        ...
        if (!taskCreationRequestDTO.description().trim().isEmpty())
            description = taskCreationRequestDTO.description();
    ...
    public Page<Task> search(Integer page, Integer size, String status, String email) {
